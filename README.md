...
### 👀 About Me:
- 🔥 Passionate about **Cybersecurity, Ethical Hacking, Digital Forensics, OSINT, and Penetration Testing**
- 🛡️ Currently working as a **SOC Analyst Intern**
- 🎓 Have completed various **Cybersecurity & Digital Forensics Certifications**
- 🕵️ Exploring **Belkasoft Windows Forensics**

### 🌱 Currently Learning:
- Advanced **Penetration Testing & Red Teaming**
- **Incident Response & Threat Hunting**
- Deep diving into **Forensic Investigations & OSINT Techniques**

### 💞️ Looking to Collaborate On:
- Open-source **Cybersecurity, Ethical Hacking & OSINT Projects**
